        ...
        <div className="bg-white p-6 rounded-lg shadow-lg w-1/3">
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart data={data}>
              ...
              <YAxis />
              <Tooltip />
              <Legend verticalAlign="bottom" height={36} /> {/* Legend positioned at the top */}
          ...
          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            >
              ...
              <div className="ps-3">
                ...
                <div className="font-normal text-gray-500">mroki815@gmail.com</div>
              </div>
            </th>
          ...
          <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
            ...
            >
              ...
              <div className="ps-3">
                ...
                <div className="font-normal text-gray-500">aminur@gmail.com</div>
              </div>
            </th>
