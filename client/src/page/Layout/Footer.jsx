...
const Footer = () => {
  ...
  return (
    <div>
      <footer
        className={pathname === "/deshboard" ? "hidden" : "bg-white py-10 mt-10 border-t"}
      >
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-20">
          ...
          <div>
            ...
            <p className="mt-1">
              Send us an email:{" "}
              <a href="mailto:care@rokomari.com" className="text-blue-500">
                care@olddraft.com
              </a>
            </p>
            <p className="mt-4">
              <strong>To be a seller? Email Us</strong> <br />
              <a href="mailto:seller@olddraft.com" className="text-blue-500">
                seller@olddraft.com
              </a>
            </p>
            <p className="mt-4 mb-3">
              ...
              <a href="mailto:sales@rokomari.com" className="text-blue-500">
                sales@olddraft.com
              </a>
            </p>
            ...
            <p className="mt-4 flex items-center space-x-2">
              <span>📧</span>
              <a href="mailto:admin@olddraft.com" className="text-blue-500">
                admin@olddraft.com
              </a>
            </p>
          </div>
        ...
        <div className="container mx-auto mt-8 flex flex-col md:flex-row justify-between items-center px-4 lg:px-20">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a href="#" className="text-2xl text-rose-500">
              <FaInstagram />
            </a>
            <a href="#" className="text-2xl">
              <RiTwitterXFill />
            </a>
            <a href="#" className="text-2xl text-rose-600">
              <FaYoutube />
            </a>
          </div>
